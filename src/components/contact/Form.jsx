...
const Form = () => {
  // 2. Create state for each input field
  ...
  return (
    <div>
      {/* PROFILE-RELEVANT CHANGE: Updated description */}
      <p className="text-[12px] xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-soft-dark">
        Have a question or a role you think I'd be a good fit for? Fill out the form below.
      </p>
      <div className="mx-2">
        {/* 4. Add the onSubmit handler to the form tag */}
        <form 
          action="https://formspree.io/f/xjkebwde" // Replace with your Formspree ID
          method="POST"
        ...
        >
          ...
          <input
            ...
            placeholder="Subject"
            className={`${commonClass}`}
            value={formData.subject} // Control the input
            onChange={handleChange} // Handle changes
            required
          />
          <input
